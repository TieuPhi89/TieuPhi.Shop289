...
const showModal = (item = null) => {
    ...
    <div class="form-group">
        <label for="Th_Nhom_Ti_Vi">Nhóm Tivi</label>
        <select id="Th_Nhom_Ti_Vi">
...
const autoKey = () => {
    let keyNhom = Th_Nhom_Ti_Vi.value;
...
const saveTivi = () => {
    ...
    let Nhom_Ti_Vi = document.querySelector("#Th_Nhom_Ti_Vi").value;
